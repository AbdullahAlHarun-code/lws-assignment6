...
const Hero = () => {
  return (
    <header className="h-[500px] bg-center flex flex-col-reverse bg-cover w-full relative">
      <Image
        src="/header.webp"
        alt="Header Image"
        style={{zIndex:"-1"}}
        ...
        quality={100}
      />
      <div className="absolute bottom-0 mb-5 w-10/12 max-w-7xl text-white mx-auto">
